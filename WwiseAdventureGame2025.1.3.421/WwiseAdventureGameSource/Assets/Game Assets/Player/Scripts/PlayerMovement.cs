...
public class PlayerMovement : MonoBehaviour
{
    ...
    public PhysicsMaterial frictionPhysMat;
    public PhysicsMaterial noFrictionPhysMat;
    ...
    void FixedUpdate()
    {
        ...
        if (wantsMove)
        {
            ...
            {
                playerBody.linearVelocity = new Vector3((movementVector.x * (maxSpeed + sprintAdd)) * Time.fixedDeltaTime * 20f * speedModifier, playerBody.linearVelocity.y + (movementVector.y * Time.deltaTime), (movementVector.z * (maxSpeed + sprintAdd)) * Time.fixedDeltaTime * 20f * speedModifier); //NORMAL MOVEMENT
            }
        }
    ...
    {
        runAmount = Mathf.Lerp(runAmount, playerBody.linearVelocity.magnitude / 7.1f, Time.deltaTime * 10f); //TODO: Fix these hard-coded number.
