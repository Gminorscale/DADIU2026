...
public class AkMicrophone : UnityEngine.MonoBehaviour
{
	...
	private bool IsPlaying { get { return m_PlayingID != AkUnitySoundEngine.AK_INVALID_PLAYING_ID; } }
	...
	void FixedUpdate()
    {
        ...
        if (IsPlaying)
        {
            ...
            AkUnitySoundEngine.GetRTPCValue((uint)MicrophoneLevelRTPC.Id, gameObject, m_PlayingID, out currentMicLevel, ref RTPCValue);
            if (IsAboveThreshold)
